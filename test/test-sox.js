const fs = require('fs'),
      ...
      { _sox } = require('../lib/gulp-nks-wav2ogg'),
...
const tests = [
  {
    ...
    conds: [
      { fadeout: 0, silence: '-90dB', freq: 44100, quality: 5 },
      { fadeout: 0, silence: '-60dB', freq: 44100, quality: 5 },
      { fadeout: 0, silence: '-40dB', freq: 44100, quality: 5 },
      { fadeout: 0, silence: '-20dB', freq: 44100, quality: 5 },
